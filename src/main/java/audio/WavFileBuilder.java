...
import progressBar.ProgressBarHandler;
...
/**
 * Class for building Wav files.<br/>
 * In the see also, I linked some resources that were key to making this class. (The first one is especially helpful if
 * you want to understand how the wav file is made) <br/>
 * @author Jonas Everaert
 * @author <a href="https://jonaseveraert.be">jonaseveraert.be</a>
 * @version %I%
 * @since 1.0
 *
 * @implNote This class requires the Apache Commons Lang Library (version 3) <a href="https://commons.apache.org/proper/commons-lang/download_lang.cgi">Download Apache Commons Lang</a>
 *
...
public class WavFileBuilder {
    ...
    /**
     * Constructs a WavFileBuilder which can be used to create wav files. <br/>
     *
     * The builder takes care of the subchunks based on the parameters that are given in the constructor. <br/><br/>
     ...
     *     for the structure of the "Data" part
     */
     ...
     * @return true if the file's audio data was successfully added to the wav file's audioData byte array, false otherwise
     */
    public boolean addAudioFile(File file) {
        ...
        try {
            ...
            if (bytesPerSample != (bitsPerSample / 8) * numChannels) {
                ...
                // TODO: convert file
                logger.log(Level.WARNING, "The bytesPerSample of the inputted file does not equal that of the be.jonaseveraert.util.audio.WavFile you are building. TODO: file conversion");
                return false;
            }
            ...
            try {
                ...
                //logger.log(Level.INFO, "Succesfully read all audio data from the file.");
                this.addBytes(audioBytes); // Add the read audio data to the file
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
     ...
     * @return true if the file was created and written to succesfully. Else false.
     */
    public boolean saveFile(File outputFile) throws IOException {
        ...
        // Combine all hex data into one String (except for the audio data, which is passed in as a byte array
