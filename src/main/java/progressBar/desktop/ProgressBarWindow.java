...
public class ProgressBarWindow extends JFrame {
     ...
     * The {@code JTextArea} is used to display the current sub-process.<br/><br/>
     * To control the progressbar, pass the {@link #getjPanel() jPanel} into a {@link ProgressBarHandler}. See the
     * {@link ProgressBarHandler}'s constructor javadoc for implementation.
     *
     * @see ProgressBarHandler
     */
